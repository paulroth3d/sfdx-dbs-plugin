...
const context = {'topic':null,'command':{'topic':'packageList','command':'convert','plugin':'sfdx-dbs-plugin','namespace':'dbs','usage':'','description':'Converts a packageList to a package','default':false,'help':'Converts a packageList to a package','fullHelp':'','hidden':false,'variableArgs':false,'disableAnalytics':false,'args':null,'flags':[{'name':'source','char':'s','description':'Relative path to the package list to convert','hasValue':true,'hidden':false,'required':false},{'name':'target','char':'t','description':'Path for the resulting package (xml) file','hasValue':true,'hidden':false,'required':false},{'name':'apiVersion','char':'v','description':'api version for the package, DEF:40.0','hasValue':true,'hidden':false,'required':false}]},'app':'','args':{},'flags':{'source':targetPackageList},'cwd':'/Users/proth/Documents/work/tools/sfdx-dbs-plugin','herokuDir':'/Users/proth/.cache/sfdx','debug':false,'debugHeaders':false,'dev':true,'supportsColor':true,'version':'sfdx-cli/5.7.7-94c4196 (darwin-amd64) go1.7.5 sfdx-dbs-plugin/0.0.1 node-v6.9.5','apiToken':'','apiHost':'api.heroku.com','apiUrl':'https://api.heroku.com','gitHost':'heroku.com','httpGitHost':'git.heroku.com'};
